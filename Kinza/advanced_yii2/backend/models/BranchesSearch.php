...
class BranchesSearch extends Branches
{
    ...
    public function rules()
    {
        return [
            [['branch_id'], 'integer'],
            [['branch_name','compnies_company_id' ,'branch_address', 'branch_created_date', 'branch_status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->joinWith('compniesCompany');
        ...
        $query->andFilterWhere(['like', 'branch_name', $this->branch_name])
            ...
            ->andFilterWhere(['like', 'companies.company_name', $this->compnies_company_id]);
